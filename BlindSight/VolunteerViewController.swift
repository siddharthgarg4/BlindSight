        ...
        db.collection("blindUsers")
            .addSnapshotListener { querySnapshot, error in
                ...
                snapshot.documentChanges.forEach { diff in
                    let alert = UIAlertController(title: "Someone needs your assistance", message: "Are you available to provide the assistance", preferredStyle: .alert)
                    alert.addAction(UIAlertAction(title: "I am busy", style: UIAlertAction.Style.destructive, handler: { action in
                        self.dismiss(animated: true, completion: nil)
                    }))
                    alert.addAction(UIAlertAction(title: "Yes, I am free to help", style: UIAlertAction.Style.default, handler: { action in
                        self.performSegue(withIdentifier: "humanSegue", sender: self)
                    }))
